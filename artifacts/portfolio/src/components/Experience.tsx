...
const experiences = [
  {
    ...
    bullets: [
      "Led end-to-end design of a responsive design system and visual language for UBL, ensuring brand consistency across all digital touchpoints.",
      "Built one-click responsive layouts in Figma using component variables and design tokens, accelerating handoff and reducing QA cycles.",
  ...
  },
  {
    ...
    bullets: [
      "Delivered user-centered UI/UX for 30+ client products across SaaS, e-commerce, and mobile app verticals, boosting client satisfaction and brand engagement.",
      "Managed the full product design lifecycle: stakeholder discovery, IA, interaction design, wireframing, prototyping, and high-fidelity mockups.",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Partnered with developers and PMs to streamline implementation, reducing design-dev misalignment and iteration time.",
