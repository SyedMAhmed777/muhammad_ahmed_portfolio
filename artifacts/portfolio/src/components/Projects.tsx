...
export const projects = [
  {
    ...
    chipColor: "text-[#6366F1] bg-[#6366F1]/10 border-[#6366F1]/20",
  },
  {
    id: 2,
    name: "Jsoor",
    subtitle: "Brand Guidelines",
    description: "Full brand identity for Jsoor Global, a GCC consultancy for startups and SMEs. Covers logo variants, clear space rules, colour palette (Pine Green, Aquamarine, Azure), DM Sans typography, and stationery across business cards, letterhead, and real-world mockups.",
    ...
    chipColor: "text-[#00796B] bg-[#00796B]/10 border-[#00796B]/20",
  },
  {
    id: 3,
    name: "Lumen",
    ...
    gradient: "from-[#FF8A3D]/25 via-amber-300/15 to-orange-200/10",
    accent: "from-[#FF8A3D] to-amber-400",
    icon: Smartphone,
    href: "/case-study/lumen",
    thumbnail: "/lumen-thumbnail.png",
    chipColor: "text-[#FF8A3D] bg-[#FF8A3D]/10 border-[#FF8A3D]/20",
    screens: [
  ...
  },
  {
    ...
    category: "Mobile App",
    badge: "Project",
    gradient: "from-[#3DCB7A]/20 via-[#FF5A5F]/10 to-[#3DCB7A]/5",
    accent: "from-[#3DCB7A] to-[#FF5A5F]",
    icon: Gamepad2,
    href: "/case-study/nicotina",
    thumbnail: "/nicotina/thumbnail.png",
    chipColor: "text-[#3DCB7A] bg-[#3DCB7A]/10 border-[#3DCB7A]/20",
  },
  {
    id: 5,
    name: "Serene",
    ...
    thumbnail: "/serene-thumbnail.png",
